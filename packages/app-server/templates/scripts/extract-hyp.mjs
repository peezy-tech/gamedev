...
async function extractHyp({ hypPath, projectAbs }) {
  ...
  const rawScriptFiles =
    blueprint.scriptFiles && typeof blueprint.scriptFiles === 'object' ? blueprint.scriptFiles : null
  const rawScriptEntry =
    typeof blueprint.scriptEntry === 'string' && blueprint.scriptEntry.trim()
      ? blueprint.scriptEntry.trim()
      : 'index.js'
