...
const names = [
  ...
  'solanaConnectChallengeRequest',
  'solanaConnectChallenge',
  'solanaConnectResponse',
  'solanaDisconnectRequest',
  'solanaDisconnect',
  'solanaDepositRequest',
  'solanaDepositSignatureRequest',
  'solanaDepositSignatureResponse',
  'solanaDepositResult',
  'solanaWithdrawRequest',
  'solanaWithdrawSignatureRequest',
  'solanaWithdrawSignatureResponse',
